...
namespace SpriteKind {
    ...
    export const bad_bird = SpriteKind.create()
}
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.bad_bird, function (sprite, otherSprite) {
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    sprites.destroy(Duck, effects.fire, 1000)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.bad_bird, function (sprite, otherSprite) {
    sprites.destroy(Duck, effects.disintegrate, 1000)
})
...
let Killer = sprites.create(img`
    ...
    4444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444444
    `, SpriteKind.Enemy)
Killer.setPosition(80, 112)
anim = animation.createAnimation(ActionKind.Jumping, 100)
...
game.onUpdateInterval(randint(2000, 4500), function () {
    if (Start == true) {
        if (Math.percentChance(50)) {
            eagle = sprites.create(img`
                ...
                ...........fff3cc33cc33c........
                `, SpriteKind.bad_bird)
            eagle.setPosition(randint(-64, 64), 65)
            eagle.setVelocity(50, 0)
        } else {
            eagle = sprites.create(img`
                ................................
                ................................
